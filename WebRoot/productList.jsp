	...
	<div style="margin-top:20px;width=100%;">
		<div id="options" class="toolbar" style="height: 30px;">
			<div style="float: left; margin-bottom: 10px;">
				...
				<select id="bp_brad" class="easyui-combobox" style="width:148px;height:26px"panelHeight="100"; editable="false">
					<option value="" <c:if test="${brad==''}">selected="true"</c:if>>活动的品牌</option>
					<option value="A" <c:if test="${brad=='A'}"> selected="true"</c:if>> AMII </option>
					<option value="R" <c:if test="${brad=='R'}">selected="true"</c:if>> Redefined</option>
				</select>
				<span style="padding: 6px;">产品定位</span>
				<input class="easyui-textbox" type="text" id="bp_spno" value="" data-options="height:26">
			</div>
			<div style=" float: left; margin-bottom: 10px;">
			...
			<div id="expertQuery" style=" float: left; margin-bottom: 10px;">
				...
				<input  class="easyui-datetimebox"  id="bp_jhdt" style="width:148px;height:26px" type="text" editable="false" value="${jhdt}" />
				<span style="padding: 10px;">下架时间</span>
				<input  class="easyui-datetimebox"  id="bp_xjdt" style="width:148px;height:26px" type="text" editable="false" value="${xjdt}" />
			</div>
		</div>
		<div style="width:100%; float: left;">
			...
			<div class="pager" id="pagebar">
				...
				<a onclick="bp_turnPage(0)">&lt;&lt; 第一页</a> <a
					onclick="if(${offset-1}<0){bp_turnPage(${offset-1})}">&lt; 上一页</a> <a
					onclick="if(${offset+1}!=${totalpage}){bp_turnPage(${offset+1})}">下一页 &gt;</a> <a
