...
<body>
	<div style="display: none;">
		<div id="addSupplier" class="easyui-window" title="添加供方信息"  modal="true"
		...
		<div id="mergerSupplier" class="easyui-window" title="修改供方信息"  modal="true"
			collapsible="false" minimizable="false" maximizable="false" closed="true" 
	...
	<div style="margin-top:20px; width:100%;">
		<div id="options" class="toolbar" style="height: 30px;">
				<div style="float: left;">
					<a onclick="showAddSupplier()" class="easyui-linkbutton"
		...
		<div style="width:100%; float: left;" id = "suppliersList">
			<table class="easyui-datagrid" style="width:100%;" singleSelect="true">
				...
				<c:forEach items="${getSupListByOption}" var="supplier" varStatus="i">
					<tr>
						...
						<td>
							<a onclick="javascript:return sureDelSup('${supplier.mtsName}','${supplier.mtsId }')">删除</a>
							<a onclick="showMergerSupplier('${supplier.mtsId}')">编辑</a>
						</td>
					</tr>
				</c:forEach>
			</table>
			...
			<div style="margin-top: 10px; text-align: center;">
				<a class="easyui-linkbutton" style="margin-left: 10px;padding: 0px 3px;" onclick="closeEditSupplier()">确定</a>
			</div>
		</div>
	</div>
