...
<body>
	<div align="center">
		<form action="" id="updatetestReportform" method="post">
			<div>
				<table class="form-table">
					...
					<tr style="margin-bottom: 50px;">
						<td>轮廓风险</td>
						<td>
							<input name="testReport.riskOfLineament" value="${testReport.riskOfLineament}" style="height: 26px;" class="easyui-textbox" />
						</td>
					</tr>
					...
					<tr style="margin-bottom: 50px;">
						<td>类目风险</td>
						<td>
							<input name="testReport.riskForClass" value="${testReport.riskForClass}" style=" height: 26px;" class="easyui-textbox" />
						</td>
					</tr>
					...
					<tr>
						<td colspan="2" style="padding-left: 100px;">
							<input type="button" value='保存' class="easyui-linkbutton" onclick="updateTestReport()" />&nbsp;&nbsp;&nbsp;&nbsp;
